...
namespace ASPNETcore5Homework.Migrations
{
    ...
    [Migration("20201210163045_AddDateModified")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Course", b =>
                {
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.CourseInstructor", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Department", b =>
                {
                    b.Property<int>("DepartmentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Enrollment", b =>
                {
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.OfficeAssignment", b =>
                {
                    b.Property<int>("InstructorId")
                        .HasColumnType("int")
                        .HasColumnName("InstructorID");
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Person", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.VwCourseStudent", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.VwCourseStudentCount", b =>
                {
                    b.Property<int>("CourseId")
                        .HasColumnType("int")
                        .HasColumnName("CourseID");
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.VwDepartmentCourseCount", b =>
                {
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Course", b =>
                {
                    b.HasOne("ASPNETcore5Homework.Models.Department", "Department")
                        .WithMany("Courses")
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.CourseInstructor", b =>
                {
                    b.HasOne("ASPNETcore5Homework.Models.Course", "Course")
                    ...
                    b.HasOne("ASPNETcore5Homework.Models.Person", "Instructor")
                        .WithMany("CourseInstructors")
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.Enrollment", b =>
                {
                    ...
                    b.HasOne("ASPNETcore5Homework.Models.Person", "Student")
                        .WithMany("Enrollments")
            ...
            modelBuilder.Entity("ASPNETcore5Homework.Models.OfficeAssignment", b =>
                {
                    b.HasOne("ASPNETcore5Homework.Models.Person", "Instructor")
                        ...
                        .HasForeignKey("ASPNETcore5Homework.Models.OfficeAssignment", "InstructorId")
